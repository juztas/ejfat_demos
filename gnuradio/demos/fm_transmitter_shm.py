...
# Title: FM Transmitter (SDR to EJFAT SHM)
# Description: Captures FM signal from SDR and streams to EJFAT SHM sink
...
class fm_transmitter_shm(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "FM Transmitter (SDR to EJFAT SHM)", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("FM Transmitter (SDR to EJFAT SHM)")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "fm_transmitter_shm")
        ...
        # Connections
        ##################################################
        self.connect((self.blocks_stream_to_vector_0, 0), (self.ejfat_ejfat_shm_sink, 0))
...
def main(top_block_cls=fm_transmitter_shm, options=None):
