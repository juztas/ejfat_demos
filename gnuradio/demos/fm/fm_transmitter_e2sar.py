...
# Title: FM Transmitter (SDR to E2SAR)
# Description: Captures FM signal from SDR and streams to E2SAR segmenter
...
class fm_transmitter_e2sar(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "FM Transmitter (SDR to E2SAR)", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("FM Transmitter (SDR to E2SAR)")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "fm_transmitter_e2sar")
...
def main(top_block_cls=fm_transmitter_e2sar, options=None):
