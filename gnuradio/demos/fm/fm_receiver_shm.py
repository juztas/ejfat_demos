...
# Title: FM Receiver (EJFAT SHM Source)
# Description: Receives FM signal from EJFAT SHM source and demodulates
...
class fm_receiver_shm(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "FM Receiver (EJFAT SHM Source)", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("FM Receiver (EJFAT SHM Source)")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "fm_receiver_shm")
...
def main(top_block_cls=fm_receiver_shm, options=None):
