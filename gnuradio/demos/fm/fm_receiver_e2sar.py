...
# Title: FM Receiver (E2SAR Reassembler)
# Description: Receives FM signal from E2SAR reassembler and demodulates
...
class fm_receiver_e2sar(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "FM Receiver (E2SAR Reassembler)", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("FM Receiver (E2SAR Reassembler)")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "fm_receiver_e2sar")
        ...
        self.vlen = vlen = 8192
        self.starting_port = starting_port = 19522
        self.fm_freq = fm_freq = 88.5
        self.ejfat_uri = ejfat_uri = "ejfat://useless@192.168.100.1:9876/lb/1?sync=192.168.0.1:12345&data=127.0.0.1"
    ...
    def set_starting_port(self, starting_port):
...
def main(top_block_cls=fm_receiver_e2sar, options=None):
