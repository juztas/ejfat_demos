...
class fm_receiver_stereo(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "FM Receiver (Stereo)", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("FM Receiver (Stereo)")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "fm_receiver_stereo")
...
def main(top_block_cls=fm_receiver_stereo, options=None):
